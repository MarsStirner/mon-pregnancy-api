...
"""
@api {post} /risar/api/integration/<api_version>/card/<external_card_id>/checkup/obs/<external_system_id>/ Регистрация осмотров акушеров-гинекологов
@apiName PostObsExamination
@apiGroup Obs-Examination
@apiVersion 0.1.0
@apiPermission auth
@apiDescription Регистрация данных первичного и повторного осмотра врача-акушера-гинеколога.
...
"""
@api {put} /risar/api/integration/<api_version>/card/<external_card_id>/checkup/obs/<external_exam_obs_id>/<external_system_id>/ Изменение осмотров акушеров-гинекологов
@apiName PutObsExamination
@apiGroup Obs-Examination
@apiVersion 0.1.0
@apiPermission auth
@apiDescription Изменение данных первичного и повторного осмотра врача-акушера-гинеколога.

@apiParam {Number} api_version Версия API от целое положительной число.
@apiParam {String} external_system_id Код внешней системы.
@apiParam {String} external_card_id Код карты во внешней учетной системе.
@apiParam {String} external_exam_obs_id Код первичного и повторного осмотра врача-акушера-гинеколога во внешней учетной системе.
"""

"""
@api {delete} /risar/api/integration/<api_version>/card/<external_card_id>/checkup/obs/<external_exam_obs_id>/<external_system_id>/ Удаление осмотров акушеров-гинекологов
@apiName DeleteObsExamination
@apiGroup Obs-Examination
@apiVersion 0.1.0
@apiPermission auth
@apiDescription Удаление данных первичного и повторного осмотра врача-акушера-гинеколога.
...
"""
@api {get} /risar/api/integration/<api_version>/card/<external_card_id>/checkup/obs/<external_system_id>/ Получение списка осмотров акушеров-гинекологов
